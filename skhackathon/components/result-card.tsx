...
const ResultCard = () => {
  ...
  return (
    <section className="text-white text-center mt-16" ref={sectionsContainer}>
      ...
      >
        คุณคือจอมเวทย์ผู้สรรค์สร้างอนาคต มีศักยภาพโดดเด่นด้านความคิดสร้างสรรค์
        เหมาะกับงานออกแบบ และยังมีความเหมาะสมในการ ทำหน้าที่เขียนโค้ดจาก
        ภาษาคอมพิวเตอร์ไหนก็ได้ ให้ออกมาเป็นเว็บไซต์ที่ใช้งานได้
      </p>
      <ExternalLink
